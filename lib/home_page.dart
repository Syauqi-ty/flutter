...
import 'package:tutorinhoho/model/category.dart';
            ...
            child: Center(
              child: Column(
                ...
                children: <Widget>[
                  ...
                  Container(
                      ...
                      child: kategoriList.length == 0
                          ...
                          : new ListView.builder(
                              ...
                              itemBuilder: (_, index) {
                                return Uhuy(kategoriList[index].judul,
                                    kategoriList[index].image);
                              })),
                  SizedBox(height: 20),
                  Align(
                    alignment: Alignment.centerLeft,
                  ...
                  Container(
                      height: 210,
                      child: kategori2List.length == 0
                          ? new Text("Getting data....")
                          : new ListView.builder(
                              scrollDirection: Axis.horizontal,
                              shrinkWrap: true,
                              itemCount: kategori2List.length,
                              itemBuilder: (_, index) {
                                return Uhuy2(kategori2List[index].judul,
                                    kategori2List[index].image);
                              })),
                  SizedBox(height: 10),
                  Padding(
                    padding: const EdgeInsets.symmetric(
